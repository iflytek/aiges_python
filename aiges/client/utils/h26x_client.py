#! /usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2023/04/29 08:53:14
# @Author  : daocoder
# @Email   : daocoder@foxmail.com
# @Origin  : https://github.com/slhck/h26x-extractor.git
...
class H26xParser:
    ...
    def get_nalu_data(self):
        self._get_nalu_positions()
        nalu_relative_pos = zip(self.nal_unit_positions, islice(self.nal_unit_positions, 1, None))
    ...
    def nalu_data_format(self, cpos, npos):
        ...
        current_nalu_stream_segment = BitStream(self.stream[cpos: npos])
        nal_unit_type, rbsp_payload = self._decode_nalu(current_nalu_stream_segment)
        h264_data = {
            "type": nal_unit_type,
