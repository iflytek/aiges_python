...
def consumer(conn):
    ...
    bb = bytearray(rb)
    result_shm = mp.shared_memory.SharedMemory( name=result_shm_name,create=True, size=len(bb))

    result_shm.buf[:len(bb)] = bb
